const RESEND_API_KEY = "re_bsAYYEas_N3WeSPuQeWdfC4YAj27cQfaA";
const RESEND_FROM_EMAIL = "KSA CRM <onboarding@resend.dev>";
const PUBLIC_APP_URL = "http://localhost:4321";
...
function companyInviteEmail(opts) {
  return {
...
function availabilityRequestEmail(opts) {
  return {
...
function purchaseOrderEmail(opts) {
  return {
...
export { PUBLIC_APP_URL as P, availabilityRequestEmail as a, companyInviteEmail as c, purchaseOrderEmail as p, sendEmail as s };
